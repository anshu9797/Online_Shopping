<?php session_start();
		...
		<table class='table'>
			<thead>
				<tr>
					...
					<th calss='text-right'>Price</th>
					<th calss='text-right'>Subtotal</th>
				</tr>
			</thead>
			<tbody>
	";
	...
	echo "
		<tr>
			...
			<td><input type='number' style='width: 50px;' onblur="up_chk_qty(this.value, '<?php echo $chk_sel_rows['chk_id']; ?>');" value='<?php echo $chk_sel_rows['chk_qty']; ?>'></td>
